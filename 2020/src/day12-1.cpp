...
template<Ship T>
void handle_instruction(T& vec, const Instruction& ins) {
	if (ins.action == 'F') {
		vec.move_forward(ins.value);
	}
	else if (ins.action == 'R') {
		vec.rotate_right(ins.value);
	}
	else if (ins.action == 'L') {
		vec.rotate_left(ins.value);
	}
	else if (ins.action == 'E') {
		vec.move_east(ins.value);
	}
	else if (ins.action == 'N') {
		vec.move_north(ins.value);
	}
	else if (ins.action == 'W') {
		vec.move_west(ins.value);
	}
	else if (ins.action == 'S') {
		vec.move_south(ins.value);
	}
}

//void handle_instruction(Ship2& vec, Waypoint& wp, const Instruction& ins) {
//	if (ins.action == 'F') {
//		vec.move_forward(ins.value,wp);
//	}
//	else if (ins.action == 'R') {
//		wp.rotate_right(ins.value);
//	}
//	else if (ins.action == 'L') {
//		wp.rotate_left(ins.value);
//	}
//	else if (ins.action == 'E') {
//		wp.move_east(ins.value);
//	}
//	else if (ins.action == 'N') {
//		wp.move_north(ins.value);
//	}
//	else if (ins.action == 'W') {
//		wp.move_west(ins.value);
//	}
//	else if (ins.action == 'S') {
//		wp.move_south(ins.value);
//	}
//}
